...
\makeatletter
  ...
  \newcommand{\DeclareMathCommand}[3]{\DeclareMathOperator{#1}{#2} \DeclareDocumentCommand#3{}{\trigbraces{#1}}}
    \DeclareMathCommand{\domain}{dom}{\dom}
    \DeclareMathCommand{\grouporder}{ord}{\ord}
    \DeclareMathCommand{\signum}{sign}{\sign}
    \DeclareMathCommand{\sinecardinal}{sinc}{\sinc}
    \DeclareMathCommand{\range}{range}{\ran}
    \DeclareMathCommand{\Automorphism}{Aut}{\Aut}
    \DeclareMathCommand{\Endomorphism}{End}{\End}
    \DeclareMathCommand{\Homomorphism}{Hom}{\Hom}
    \DeclareMathCommand{\GgeneralLinearGroup}{GL}{\GL}
    \DeclareMathCommand{\Kernel}{Ker}{\Ker}
    \DeclareMathCommand{\Mapping}{Map}{\Map}
    \DeclareMathCommand{\LinearSpan}{Span}{\Span}
    \DeclareMathCommand{\StabilizerSubgroup}{Stab}{\Stab}

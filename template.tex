...
\ifthenelse{\isundefined{\chapter}}{}{
  ...
  \newcommand{\lchapterf}{\@ifstar{\schapter}{\achapter}}
    \newcommand{\achapterf}[2]{\chapter{#1} \label{chap:#2}}
    \newcommand{\schapterf}[2]{\chapter*{#1} \label{chap:#2}}
}
...
\newcommand{\thm}{\@ifstar{\sthm}{\athm}}
  \newcommand{\sthm}[2]{\begin{theorem} \, \par #1 \label{thm:\thetheorem} \end{theorem} \begin{proof} \, \par #2 \end{proof} \, \par}
  \newcommand{\athm}[3]{\begin{theorem} \textbf{#1} \par #2 \label{thm:#1} \end{theorem} \begin{proof} \, \par #3 \end{proof} \, \par}
  \newcommand{\thmf}[4]{\begin{theorem} \textbf{#1} \par #3 \label{thm:#2} \end{theorem} \begin{proof} \, \par #4 \end{proof} \, \par}
...
\newcommand{\lem}{\@ifstar{\slem}{\alem}}
  \newcommand{\slem}[2]{\begin{lemma} \, \par #1 \label{lem:\thetheorem} \end{lemma} \begin{proof} \, \par #2 \end{proof} \, \par}
  \newcommand{\alem}[3]{\begin{lemma} \textbf{#1} \par #2 \label{lem:#1} \end{lemma} \begin{proof} \, \par #3 \end{proof} \, \par}
  \newcommand{\lemf}[4]{\begin{lemma} \textbf{#1} \par #3 \label{lem:#2} \end{lemma} \begin{proof} \, \par #4 \end{proof} \, \par}
